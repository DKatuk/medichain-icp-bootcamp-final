# MediChain ICP Bootcamp Final Project

## AIM

MediChain is Decentralized Hospital Management System where users can make CRUD operations for Speciality, Doctor and Appointments
